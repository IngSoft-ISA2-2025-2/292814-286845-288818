...
Feature: Validación Segura de Reservas
    ...
    Scenario: Sistema genera claves público-privada al crear una reserva exitosamente
        ...
        And muestra un mensaje que dice "Reserva creada exitosamente. Guarde su clave pública para retirar el medicamento en la farmacia."
    ...
    Scenario: Cliente presenta clave pública válida en la farmacia para validar reserva
        ...
        And muestra un mensaje que dice "Reserva validada exitosamente. Puede proceder con la entrega del medicamento."
    ...
    Scenario: Cliente presenta clave pública inválida o inexistente en la farmacia
        ...
        And muestra un mensaje que dice "La clave pública proporcionada no es válida o no existe"
    ...
    Scenario: Cliente presenta clave pública de una reserva ya expirada
        ...
        And muestra un mensaje que dice "La reserva ha expirado y no puede ser utilizada"
    ...
    Scenario: Cliente presenta clave pública de una reserva cancelada
        ...
        And hago click en el botón de validar
        Then el sistema responde con un error de tipo "forbidden (403)"
        And muestra un mensaje que dice "La reserva fue cancelada y la clave pública ya no es válida"
    ...
    Scenario: Empleado de farmacia valida reserva con clave pública y completa la entrega
        ...
        And hago click en el botón de validar
        And confirmo la entrega del medicamento
        Then el sistema marca la reserva como "Retirada"
        And invalida la clave pública para evitar reutilización
        And muestra un mensaje que dice "Entrega completada exitosamente. La reserva ha sido cerrada."

    Scenario: Sistema invalida clave pública después de múltiples intentos fallidos de validación
        Given estoy en la página de validación de reservas en farmacia
        And tengo habilitada la protección contra intentos de fuerza bruta
        When ingreso una clave pública incorrecta "PUBKEY-WRONG001" y hago click en validar
        And ingreso otra clave pública incorrecta "PUBKEY-WRONG002" y hago click en validar
        And ingreso otra clave pública incorrecta "PUBKEY-WRONG003" y hago click en validar
        And ingreso otra clave pública incorrecta "PUBKEY-WRONG004" y hago click en validar
        And ingreso otra clave pública incorrecta "PUBKEY-WRONG005" y hago click en validar
        Then el sistema bloquea temporalmente la validación por seguridad
        And muestra un mensaje que dice "Demasiados intentos fallidos. Por favor, intente nuevamente en 15 minutos."
