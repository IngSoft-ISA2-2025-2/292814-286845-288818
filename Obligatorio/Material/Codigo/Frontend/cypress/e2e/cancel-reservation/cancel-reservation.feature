Feature: Cancelar reservas
  ...
  Scenario: Cancelación exitosa de una reserva existente
    ...
    And el sistema muestra el mensaje de cancelación "Reserva cancelada correctamente"
  ...
  Scenario: Intento de cancelación con secret incorrecto
    ...
    And el sistema muestra el mensaje de error de cancelación "Secret inválido para ese correo"
  ...
  Scenario: Intento de cancelación cuando no existe reserva para ese correo
    ...
    Then el sistema responde con un error de cancelación indicando "No existe una reserva asociada a ese correo"
  ...
  Scenario: Intento de cancelar una reserva que ya fue cancelada (idempotencia)
    ...
    And el sistema muestra el mensaje de cancelación "La reserva ya está cancelada" o una respuesta idempotente apropiada
  ...
  Scenario: Validación - falta de secret o correo inválido
    ...
    Then el sistema responde con un error de cancelación indicando "Se requiere un correo válido"
  ...
  Scenario: Intento de cancelación de una reserva expirada
    ...
    And devuelve el mensaje de cancelación "No se puede cancelar una reserva expirada"