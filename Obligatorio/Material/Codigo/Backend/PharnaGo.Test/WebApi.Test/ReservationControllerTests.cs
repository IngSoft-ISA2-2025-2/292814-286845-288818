...
namespace PharmaGo.Test.WebApi.Test
{
    ...
    public class ReservationControllerTests
    {
        ...
        public void GetReservationsByUser_FilterByEstado_ReturnsOnlyFilteredReservations()
        {
            ...
            // Simula que el manager retorna solo las reservas "Confirmada"
            _reservationManagerMock
                .Setup(service => service.GetReservationsByUser(request.Email, request.Secret))
                .Returns(reservas.Where(r => r.Status == ReservationStatus.Confirmada).ToList());
            ...
            Assert.AreEqual("Confirmada", value[0].Status);
        }
    }
}